  ...
  return (
    <section className="relative flex min-h-[80vh] flex-col items-center justify-center pb-24 pt-16 text-center">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <p className="mt-8 text-lg max-w-4xl font-medium text-gray-300 md:text-2xl">
          <span className="text-sky-400 font-semibold">Seat Picker</span> is a
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-6">
          ...
          >
            ...
            <span className="ml-2 rounded bg-slate-800 px-2 py-0.5 text-xs font-mono text-sky-400 opacity-80">
              Ctrl K
            </span>
          </button>
        </div>
